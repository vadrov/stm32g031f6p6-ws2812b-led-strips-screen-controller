...
File_Manager_File_Types filetype (char *name)
{
...
static void Dos866toCp1251 (char *fn)
{
...
#if FILE_MANAGER_MINI == 1
   				LCD_WriteChar(fm->lcd, fm->x, fm->y + yyy, icon, fm->font, bg_color, text_color, LCD_SYMBOL_PRINT_FAST);
#else
